...
namespace Protocol.Manager
{
    ...
    public class CXMLPort
    {
        ...
        /// 通讯方式
        /// </summary>
        [XmlAttribute(AttributeName = "ConnectMethod")]
        public bool BTcpOrUdp { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (temp != null)
            {
                if (this.PortNumber == temp.PortNumber && this.BTcpOrUdp == temp.BTcpOrUdp && this.BAutoStart == temp.BAutoStart && this.BStartOrNot == temp.BStartOrNot)
                    return true;
            }
            return false;
        }

...
#pragma warning disable CS0414 // 字段“CDataGridViewRealityWater.CS_OnlineOrOffline”已被赋值，但从未使用过它的值
        private static readonly string CS_OnlineOrOffline = "在线状态";
#pragma warning restore CS0414 // 字段“CDataGridViewRealityWater.CS_OnlineOrOffline”已被赋值，但从未使用过它的值
...
#pragma warning disable CS0169 // 从不使用字段“CDataGridViewRealityWater.m_itemOfflineFirst”
        private ToolStripMenuItem m_itemOfflineFirst;
#pragma warning restore CS0169 // 从不使用字段“CDataGridViewRealityWater.m_itemOfflineFirst”
        ...
        private void DownForUI_EventHandler_2(object sender, DownEventArgs e)
        {
            try
            {
                ...
                {
                    #region 更新UI
                    if (info.realWater.HasValue && type.Equals("1G13"))
                    {
                        try
                        {

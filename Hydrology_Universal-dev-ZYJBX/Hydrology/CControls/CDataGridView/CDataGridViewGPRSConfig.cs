...
namespace Hydrology.CControls
{
    ...
    class CDataGridViewGPRSConfig : CExDataGridView
    {
        ...
        public void InitDataSource()
        {
            ...
            if(listHDGprs != null)
            {
                foreach (IHDGprs hdgprs in listHDGprs)
                {
                    ...
                    //{
                    //    // 正在监听端口
                    listPortStarted.Add(hdgprs.GetCurrentPort());
                    // }
                }
            }
        ...
        public  bool DoSave(IntPtr intPtr)
        {
            if (this.IsCurrentCellInEditMode)
            {
                //MessageBox.Show("请完成当前的编辑");
            ...
            if (result)
            {
                ...
                //}
                CPortDataMgr.Instance.StartHDGprs(intPtr, false);
        ...
        protected void InitUI()
        {
            ...
            for (int i = 0; i < m_listPortConfig.Count; ++i)
            {
                ...
                else
                {
                    ...
                    CPortDataMgr.Instance.StopHDGprs((ushort)m_listPortConfig[i].PortNumber);
                }

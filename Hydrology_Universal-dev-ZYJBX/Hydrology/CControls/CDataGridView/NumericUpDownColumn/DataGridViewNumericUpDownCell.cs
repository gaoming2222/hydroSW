...
namespace Hydrology.CControls
{
    ...
    public class DataGridViewNumericUpDownCell : DataGridViewTextBoxCell
    {
        ...
        [ThreadStatic]
#pragma warning disable CS0169 // 从不使用字段“DataGridViewNumericUpDownCell.paintingNumericUpDown”
        private static NumericUpDown paintingNumericUpDown;
#pragma warning restore CS0169 // 从不使用字段“DataGridViewNumericUpDownCell.paintingNumericUpDown”
        ...
        //    editingControlBounds.Y += 2; // make it in the center of the cell
        ...
        //            // added by cln
        //            paintingNumericUpDown.Visible = false;  //hidden the control
        //            Label tmpLabel = new Label() { Text = paintingNumericUpDown.Text, Dock = DockStyle.Fill, Parent = paintingNumericUpDown };
        ...
        //                tmpLabel.DrawToBitmap(renderingBitmap, srcRect);

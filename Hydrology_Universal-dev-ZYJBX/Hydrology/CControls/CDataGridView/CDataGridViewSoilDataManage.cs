...
{
    class CDataGridViewSoilDataManage : CExDataGridView
    {
      #region 静态常量
...
#pragma warning disable CS0414 // 字段“CDataGridViewSoilDataManage.CS_OnlineOrOffline”已被赋值，但从未使用过它的值
        private static readonly string CS_OnlineOrOffline = "在线状态";
#pragma warning restore CS0414 // 字段“CDataGridViewSoilDataManage.CS_OnlineOrOffline”已被赋值，但从未使用过它的值
        private static readonly string CS_10Soil = "10cm墒情";
        private static readonly string CS_20Soil = "20cm墒情";
        private static readonly string CS_30Soil = "30cm墒情";
...
#pragma warning disable CS0169 // 从不使用字段“CDataGridViewSoilDataManage.m_itemOfflineFirst”
        private ToolStripMenuItem m_itemOfflineFirst;
#pragma warning restore CS0169 // 从不使用字段“CDataGridViewSoilDataManage.m_itemOfflineFirst”
        ...
        private void SetStationData(List<CEntitySoilStation> listStation)
        {
        ...
        public void SetSubCenterName(string subcenterName)
        {
            try
            {
                ...
                {
                    // 加载所有的用户分中心
                    List<CEntitySoilStation> listSoilStation = CDBSoilDataMgr.Instance.GetAllSoilStation();
                    SetStationData(listSoilStation);
                }
                else
                {
                    // 根据分中心查找测站
                    List<CEntitySoilStation> listAllStation = CDBSoilDataMgr.Instance.GetAllSoilStation();
...
#pragma warning restore CS0168 // 声明了变量“e”，但从未使用过
        ...
        //                CBatchManagement.ListOnlineStation4.Add(CDBDataMgr.Instance.GetStationByGprs(uid));
        //            }
        //            return;
        //        }
        //    }
        ...
        //    //CBatchManagement.ListOnlineStation4.Add(entity1);
        //    // this.m_totalGprsCount += 1;
        //}
        ...
        public void EHOnlineFirst(object sender, EventArgs e)
        {
            ...
            {
                // 排序
                this.Sort(this.Columns[CS_10Soil], System.ComponentModel.ListSortDirection.Descending);
            }
        }
        ...
        public void EHRecoverDefault(object sender, EventArgs e)
        {
            ...
            {
                // 排序
                this.Sort(this.Columns[CS_10Soil], System.ComponentModel.ListSortDirection.Ascending);

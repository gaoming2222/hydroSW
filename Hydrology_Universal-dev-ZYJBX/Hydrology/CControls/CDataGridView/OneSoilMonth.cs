...
namespace Hydrology.CControls
{
    ...
    class OneSoilMonth : CExDataGridView
    {
        ...
        private static readonly string water30 = "30cm含水率";
        private static readonly string mes = "备注";
        #endregion 静态常量

        #region 成员变量
#pragma warning disable CS0169 // 从不使用字段“OneSoilMonth.m_proxyWater”
        private IWaterProxy m_proxyWater;
#pragma warning restore CS0169 // 从不使用字段“OneSoilMonth.m_proxyWater”

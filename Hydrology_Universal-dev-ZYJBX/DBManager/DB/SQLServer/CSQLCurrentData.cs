...
#pragma warning disable CS0169 // 从不使用字段“CSQLCurrenData.m_strStaionId”
        private string m_strStaionId;       //需要查询的测站
#pragma warning restore CS0169 // 从不使用字段“CSQLCurrenData.m_strStaionId”
#pragma warning disable CS0169 // 从不使用字段“CSQLCurrenData.m_startTime”
        private DateTime m_startTime;  //查询起始时间
#pragma warning restore CS0169 // 从不使用字段“CSQLCurrenData.m_startTime”
#pragma warning disable CS0169 // 从不使用字段“CSQLCurrenData.m_endTime”
        private DateTime m_endTime;    //查询结束时间
#pragma warning restore CS0169 // 从不使用字段“CSQLCurrenData.m_endTime”
